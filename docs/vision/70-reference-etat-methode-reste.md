...
bash bench/winediff.sh              # axe 2 vs Wine (129/129)
...
**129/129** · cpudiff vert (per-instruction + séquences génératives) · funcdiff corpus **0 divergence** (lift **~20,6k** scorées /
