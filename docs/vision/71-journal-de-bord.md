...
- **Preuves** : gate `crt_mfence` (asm inline `mfence`/`lfence`/`sfence` + boucle) **PASS 1/1** ; régression : difftest **272/272**, funcdiff **0 divergence**, transpile-hash **4/4**. Preuve canonique MCP full winediff → KN-0046 (attendu **273/273** avec `crt_mfence`).
