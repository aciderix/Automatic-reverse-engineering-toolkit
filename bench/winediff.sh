...
run_one() {
  ...
  # demand-loaded.
  if ! "$MINGW" -O1 -w $xcflags "$src" $imp_lib $res_obj -lversion -lole32 -loleaut32 -luuid -luser32 -lgdi32 -lcomctl32 -lwinspool -llz32 -lshlwapi -o "$WD/$name.exe" 2>"$WD/err"; then
