...
FUNCS="add1:i addsub:i mulshift:i maxi:i mini:i absdiff:i sign:i clampu:i mix:i sumto:i countbits:i \
       ...
       sortpair:i poly:i stackarr:i fieldsum:p nestcond:i sumrec:i borrow:i cmp3:i favg:i fpoly:i fcmp:i fmix:i div64:i idiv64:i bswapi:i clz:i ctz:i widen:p interleave:q tlen:s stkarr:i x87arith:i x87cmp:i x87div:i rotl:i rotr:i imulh:i xchg3:i vshuf:i"
