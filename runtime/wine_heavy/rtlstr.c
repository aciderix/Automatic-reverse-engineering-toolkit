/* VENDORED from Wine wine-9.0 dlls/ntdll/rtlstr.c (LGPL-2.1+), with forward declarations
 * spliced in by tools/gen_wine_heavy.py so it compiles against a self-contained NT-types
 * layer (native cc; ARET has no mingw). Heavy-form (doc 82). Do not edit by hand; re-vendor
 * with tools/gen_wine_heavy.py + the splice. */
/*
...
void WINAPI RtlInitAnsiString(PANSI_STRING target, /* [I/O] Buffered ansi string to be initialized */ PCSZ source);
NTSTATUS WINAPI RtlInitAnsiStringEx(PANSI_STRING target, PCSZ source);
void WINAPI RtlInitString(PSTRING target, /* [I/O] Buffered string to be initialized */ PCSZ source);
...
void WINAPI RtlInitUnicodeString(PUNICODE_STRING target, /* [I/O] Buffered unicode string to be initialized */ PCWSTR source);
NTSTATUS WINAPI RtlInitUnicodeStringEx(PUNICODE_STRING target, /* [I/O] Buffered unicode string to be initialized */ PCWSTR source);
...
NTSTATUS WINAPI RtlDuplicateUnicodeString(int add_nul, /* [I] flag */ const UNICODE_STRING *source, /* [I] Unicode string to be duplicated */ UNICODE_STRING *destination);
...
LONG WINAPI RtlCompareUnicodeString(const UNICODE_STRING *s1, const UNICODE_STRING *s2, BOOLEAN CaseInsensitive);
BOOLEAN WINAPI RtlEqualString(const STRING *s1, const STRING *s2, BOOLEAN CaseInsensitive);
BOOLEAN WINAPI RtlEqualUnicodeString(const UNICODE_STRING *s1, const UNICODE_STRING *s2, BOOLEAN CaseInsensitive);
BOOLEAN WINAPI RtlPrefixString(const STRING *s1, const STRING *s2, BOOLEAN ignore_case);
NTSTATUS WINAPI RtlEqualComputerName(const UNICODE_STRING *left, const UNICODE_STRING *right);
NTSTATUS WINAPI RtlEqualDomainName(const UNICODE_STRING *left, const UNICODE_STRING *right);
NTSTATUS WINAPI RtlAnsiStringToUnicodeString(PUNICODE_STRING uni, /* [I/O] Destination for the unicode string */ PCANSI_STRING ansi, /* [I] Ansi string to be converted */ BOOLEAN doalloc);
NTSTATUS WINAPI RtlOemStringToUnicodeString(UNICODE_STRING *uni, /* [I/O] Destination for the unicode string */ const STRING *oem, /* [I] Oem string to be converted */ BOOLEAN doalloc);
NTSTATUS WINAPI RtlUnicodeStringToAnsiString(STRING *ansi, /* [I/O] Destination for the ansi string */ const UNICODE_STRING *uni, /* [I] Unicode string to be converted */ BOOLEAN doalloc);
NTSTATUS WINAPI RtlUnicodeStringToOemString(STRING *oem, const UNICODE_STRING *uni, BOOLEAN doalloc);
CHAR WINAPI RtlUpperChar(CHAR ch);
void WINAPI RtlUpperString(STRING *dst, const STRING *src);
NTSTATUS WINAPI RtlUpcaseUnicodeStringToAnsiString(STRING *ansi, const UNICODE_STRING *uni, BOOLEAN doalloc);
NTSTATUS WINAPI RtlUpcaseUnicodeStringToOemString(STRING *oem, const UNICODE_STRING *uni, BOOLEAN doalloc);
NTSTATUS WINAPI RtlUpcaseUnicodeStringToCountedOemString(STRING *oem, const UNICODE_STRING *uni, BOOLEAN doalloc);
DWORD WINAPI RtlAnsiStringToUnicodeSize(const STRING *str);
DWORD WINAPI RtlUnicodeStringToAnsiSize(const UNICODE_STRING *str);
NTSTATUS WINAPI RtlAppendAsciizToString(STRING *dest, /* [I/O] Buffered character string to which src is concatenated */ LPCSTR src);
NTSTATUS WINAPI RtlAppendStringToString(STRING *dest, /* [I/O] Buffered character string to which src is concatenated */ const STRING *src);
NTSTATUS WINAPI RtlAppendUnicodeToString(UNICODE_STRING *dest, /* [I/O] Buffered unicode string to which src is concatenated */ LPCWSTR src);
NTSTATUS WINAPI RtlAppendUnicodeStringToString(UNICODE_STRING *dest, /* [I/O] Buffered unicode string to which src is concatenated */ const UNICODE_STRING *src);
NTSTATUS WINAPI RtlFindCharInUnicodeString(int flags, /* [I] Flags */ const UNICODE_STRING *main_str, /* [I] Unicode string in which one or more characters are searched */ const UNICODE_STRING *search_chars, /* [I] Unicode string which contains the characters to search for */ USHORT *pos);
BOOLEAN WINAPI RtlIsTextUnicode(LPCVOID buf, INT len, INT *pf);
NTSTATUS WINAPI RtlCharToInteger(PCSZ str, /* [I] '\0' terminated single-byte string containing a number */ ULONG base, /* [I] Number base for conversion (allowed 0, 2, 8, 10 or 16) */ ULONG *value);
NTSTATUS WINAPI RtlIntegerToChar(ULONG value, /* [I] Value to be converted */ ULONG base, /* [I] Number base for conversion (allowed 0, 2, 8, 10 or 16) */ ULONG length, /* [I] Length of the str buffer in bytes */ PCHAR str);
NTSTATUS WINAPI RtlUnicodeStringToInteger(const UNICODE_STRING *str, /* [I] Unicode string to be converted */ ULONG base, /* [I] Number base for conversion (allowed 0, 2, 8, 10 or 16) */ ULONG *value);
NTSTATUS WINAPI RtlIntegerToUnicodeString(ULONG value, /* [I] Value to be converted */ ULONG base, /* [I] Number base for conversion (allowed 0, 2, 8, 10 or 16) */ UNICODE_STRING *str);
...
NTSTATUS WINAPI RtlFormatMessage(const WCHAR *src, ULONG width, BOOLEAN ignore_inserts, BOOLEAN ansi, BOOLEAN is_array, va_list *args, WCHAR *buffer, ULONG size, ULONG *retsize);
NTSTATUS WINAPI RtlFormatMessageEx(const WCHAR *src, ULONG width, BOOLEAN ignore_inserts, BOOLEAN ansi, BOOLEAN is_array, va_list *args, WCHAR *buffer, ULONG size, ULONG *retsize, ULONG flags);
